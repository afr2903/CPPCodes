...
int main(){           // ¡Comenzamos!
    long long int n;         // NÚMERO DE LADOS DEL POLÍGONO. ¡CAMBIAD ESTO!
    ...
    cout.precision(100); // Estos son el número de digitos que quiero que se expulsen por pantalla. Puedes aumentarlo si quieres.
